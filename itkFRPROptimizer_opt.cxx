...
namespace itk
{
	...
	void
		...
		::StartOptimization()
		{
			std::cout<<"Hola Christian como estas"<<std::endl;
			unsigned int i;
			...
			FRPROptimizer_opt::ParametersType tempCoord( this->GetSpaceDimension() );

			double                        gg, gam, dgg;
			FRPROptimizer_opt::ParametersType g( this->GetSpaceDimension() );
			FRPROptimizer_opt::ParametersType h( this->GetSpaceDimension() );
			FRPROptimizer_opt::ParametersType xi( this->GetSpaceDimension() );

			FRPROptimizer_opt::ParametersType p( this->GetSpaceDimension() );
